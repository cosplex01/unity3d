...
LRESULT CALLBACK testWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	{
		TCHAR szBuf[256];
		swprintf_s(szBuf,sizeof(szBuf)/sizeof(TCHAR),L"key:%8d",wParam);
	...
	case WM_PAINT:
	{
		...
		TextOut(hdc, 200, 0, L"hello subclsing", wcslen(L"hello subclsing"));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		{
			testWnd = CreateWindow(L"edit", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_AUTOHSCROLL,
			10, 10, 128, 20, hWnd, (HMENU)1001, hInst, NULL);
			SetFocus(testWnd);
			oldEditProc = (WNDPROC)SetWindowLong(testWnd, GWL_WNDPROC, (LONG)testWndProc);

			CreateWindow(L"static", L"hello basic", WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_AUTOHSCROLL,
				10, 10, 128, 20, hWnd, (HMENU)1001, hInst, NULL);
		}
    case WM_COMMAND:
        {
